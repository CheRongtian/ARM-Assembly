// Listing1-4.cpp
//
// Generic C++ driver program to call AoAA programs
// Also includes a "readline" function that reads a string
// from the user and passes it on to the assembly language
// code
//
// Need to include studio.h so this program can call "printf"
// and studio.h so this program can call strlen.
...
// more), this function returns the only first maxLen - 1
